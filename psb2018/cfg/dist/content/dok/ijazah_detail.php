<?php
  ...
  $sql = $conn->prepare("SELECT * FROM psb, dok_ijazah
                     ...
                     AND dok_ijazah.id_dok_ijazah = :id_dok_ijazah ");
  $sql->bindParam(":id_dok_ijazah", mysql_real_escape_string(stripslashes(strip_tags($_GET['tid']))));
  $sql->execute();
  while($r = $sql->fetch()){
?>
    ...
    <div class="box">
      ...
      <header>
        <div class="icons">
          <i class="fa fa-th-large"></i>
            ...
            <h5>Rincian Kelengkapan Dokumen Ijazah/SKHU/SKL</h5>
      ...
      <div id="div-1" class="body collapse in">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input type="text" id="tgl" name="tgl" placeholder="Tanggal unggah dokumen kartu keluarga" class="form-control" value="<?php echo tgl_indo($r['tgl_up_ijazah']); ?>" required="required" readonly>
            </div>
          </div>
          ...
          ?>
              <div class="form-group">
                <div class="col-lg-8">
                  <?php echo "<img src='./../dist/img_ijazah/$r[pic_dok_ijazah]' >"; ?>
                </div>
              </div>
            <?php } else { ?>
              <div class="form-group">
                <div class="col-lg-8">
                  <?php echo "<img src='./../dist/img_ijazah/image_not_available.jpg' oncontextmenu='return false;'>"; ?>"; ?>
